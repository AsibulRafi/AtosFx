...
const Privacy = () => {
  ...
  return (
    <section className="resources">
      <h2 className="resources__heading">Privacy Policy</h2>
      <div className="resources__content">
        ...
        <p>
          At the time activating of your profile at AtosFX, we would request
        ...
        <p>
          ...
          statements, bank card information and so on. Attention: AtosFX is
        ...
        <p>
          Attention: AtosFX xwants to clarify that it does not purposefully keep
          or gather any information of any individuals under the age of
          thirteen.
        </p>
        <p>
          If it comes to the knowledge of AtosFX that information has been
        ...
        <p>
          ...
          as cookies. AtosFX gathers necessary data by using the cookies. Don`t
          worry, as cookies don`t have any private information regarding the
          user in them, with the exception when the user has provided such
          information by himself – like when opening a profile at a website.
          AtosFX will utilize the cookies for the purpose of identifying and
          quantifying platform traffic, along with measuring how certain
          services and ads are performing.
        </p>
        <p>
          This way AtosFX can better gauge the ways in which the users are
          ...
          might also be made available to AtosFX staff, partners, and
          associates. AtosFX will not use the information for commercial
          purposes by providing it to any unassociated individuals or entities.
        </p>
        <p>
          When the user goes to AtosFX , there might be other affiliated parties
          that also place their cookies on the user`s computer. We would advise
          you to take a look at the terms and conditions of those affiliate
          parties` websites in case you have any questions or issues regarding
          their placement of cookies. Usually, the usage of cookies is the same
          as on AtosFX .
        </p>
        ...
        <p>
          ...
          as it is being kept by AtosFX , following the privacy terms and
          conditions stated on the platform.
        </p>
        <h2>5. Other Parties.</h2>
        <p>
          With the exception of the parties stated in the privacy protocol,
          AtosFX will not share your data with any other parties. Sometimes we
          ...
          that take care of the fund`s transfer process at AtosFX .
          Additionally, it might include firms responsible for any legal and
          financial matters at AtosFX . Any party which is not a direct
          association to AtosFX should keep the provided user data to the same
          degree in which it is received. The non-associate party can only
          utilize the given user data in order to provide the specified service
          and for no other reasons. In some cases, AtosFX might give out a
          clients` private data to another party given that there are certain
          instructions that need to be accomplished. Know that AtosFX would
          ...
          the law, AtosFX might share private user data given to other parties.
          The shared information might contain private specifics in order to
          meet the requirements of the law, as well as securing the rights and
          integrity of the platform.
        </p>
        <h2>6. Consolidation and insolvency.</h2>
        <p>
          All private client data will be consolidated following the platform,
          in case there is a merger of AtosFX . Stated in the inclusion terms
        ...
        <p>
          AtosFX does not hold any data related to client`s credit card
        ...
        <p>
          ...
          AtosFX . Be mindful though, that any info you omit might lead to
          issues with your trading profile. It might also have an impact on the
          services we`re able to offer you.
        </p>
        <h2>9. Pulling out.</h2>
        <p>
          If you wish for AtosFX to delete all your private information from the
          platform and the servers, you will need to send us a detailed message.
          Know that any omitted data might result in issues with your profile
          and consequently lead to inadequacy with the platform services.
        </p>
        <h2>10. Corrections.</h2>
        <p>
          If any corrections are made, which change the policies and protocol
          for private data gathered by AtosFX , the clients will be promptly
        ...
        <p>
          ...
          always a dedicated AtosFX employee to answer your questions.
        </p>
        <p>
          Phone:
          <br />
